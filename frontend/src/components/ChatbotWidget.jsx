...
export default function ChatbotWidget({ module = "gerenciamento", accentColor = "#E31A1A" }) {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content: `Olá! Sou o assistente virtual da CRA Construtora. Tenho acesso a todas as informações da plataforma e posso ajudar com:\n\n• Informações sobre máquinas e manutenções\n• Status do estoque\n• Dados financeiros (contas, OS, aluguéis)\n• Estatísticas e relatórios\n\nComo posso ajudar?`
    }
  ]);
              ...
              >
                ...
                >
                  <div className="flex items-start gap-2">
                    {msg.role === "assistant" && (
                      <Bot size={16} className="mt-0.5 shrink-0" style={{ color: accentColor }} />
                    )}
