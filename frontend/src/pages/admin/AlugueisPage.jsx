  ...
  const openModal = (aluguel = null) => {
    ...
    if (aluguel) {
      ...
      setFormData({
        ...
        valor: aluguel.valor ? formatCurrencyInput((aluguel.valor * 100).toString()) : "",
        valor_caucao: aluguel.valor_caucao ? formatCurrencyInput((aluguel.valor_caucao * 100).toString()) : "",
