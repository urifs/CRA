...
import { 
  Plus, Search, CreditCard, Calendar, CheckCircle2, AlertCircle, Clock, Edit, Trash2, X, Filter, Paperclip, UserPlus
} from "lucide-react";
                  ...
                  >
                    ...
                    <td className="p-3 text-center" onClick={(e) => e.stopPropagation()}>
                      <div className="flex justify-center gap-1">
                        {c.status === "em_aberto" && <Button size="sm" variant="outline" className="text-green-600" onClick={() => openQuitarModal(c)} title="Quitar"><CheckCircle2 size={14} /></Button>}
