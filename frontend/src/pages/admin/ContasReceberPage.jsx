    ...
    <div data-testid="contas-receber-page">
      <div className="page-header">
        <div>
          ...
          <p className="text-slate-500 mt-1">Gestão de receitas e recebimentos</p>
        </div>
      ...
      {filteredContas.length === 0 ? (
        <Card><CardContent className="py-12 text-center text-slate-400"><Wallet className="mx-auto mb-4" size={48} /><p>Nenhuma conta encontrada</p></CardContent></Card>
      ) : (
