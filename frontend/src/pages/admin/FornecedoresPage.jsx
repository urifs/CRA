  ...
  return (
    <div data-testid="fornecedores-page">
      ...
      <div className="page-header">
        ...
        <Button onClick={() => openModal()} className="bg-blue-600 hover:bg-blue-700" data-testid="new-fornecedor-btn">
        ...
        <DialogContent className="max-w-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <Button type="submit" className="flex-1 bg-blue-600 hover:bg-blue-700" data-testid="submit-fornecedor">
